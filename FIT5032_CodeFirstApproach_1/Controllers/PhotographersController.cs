...
namespace FIT5032_CodeFirstApproach_1.Controllers
{
    public class PhotographersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PhotographerID,Name,organization,eventscovered")] Photographer photographer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PhotographerID,Name,organization,eventscovered")] Photographer photographer)
        {
            if (ModelState.IsValid)
            {
